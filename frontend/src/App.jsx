...
export default function App() {
  ...
  useEffect(() => {
    fetch("https://insight-ai-backend-98tv.onrender.com/api/health")
      .then(r => r.json())
  ...
  const handleUpload = useCallback(async (file) => {
    ...
    try {
      ...
      const res = await fetch("https://insight-ai-backend-98tv.onrender.com/api/upload", { method: "POST", body: formData });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch("https://insight-ai-backend-98tv.onrender.com/api/generate", {
        method: "POST",
